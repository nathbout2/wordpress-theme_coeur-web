...
<div class="col-md-6 col-sm-12 order-md-2 order-sm-1">
    ...
    <img src="<?= get_template_directory_uri(); ?>/assets/images/Lost.svg" class ="imagetext">
...
<div class="col-md-6 col-sm-12 order-md-1 order-sm-1">
    ...
    <img src="<?= get_template_directory_uri(); ?>/assets/images/Websdesigner.svg" class ="imagetext">
...
<div class="col-md-6 col-sm-12 order-md-2 order-sm-1">
    ...
    <img src="<?= get_template_directory_uri(); ?>/assets/images/chefdeprojet.svg" class ="imagetext">
...
<div class="container3">
     <div class="row align-items-start">
          <div class="col"><a href="motion-designer.php">
             <img src="<?= get_template_directory_uri(); ?>/assets/images/motiondesignmini.svg" class="motiondesignmini" alt="..."></a>
             <h5 class="tittle1"><b>Motion designer web</b></h5>
         </div>
          <div class="col"><a href="graphiste.php">
             <img src="<?= get_template_directory_uri(); ?>/assets/images/graphiste1.svg" class="graphiste1" alt="..."></a>
             <h5 class="tittle1"><b>Graphiste, un métier créatif</b></h5>
         </div>
          <div class="col"><a href="pentesteur.php">
             <img src="<?= get_template_directory_uri(); ?>/assets/images/pentesteurminia.svg" class="pentesteurminia" alt="..."></a>
